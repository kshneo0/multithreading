...
import (
	...
	. "github.com/multithreading/ch33/common"
)


func lockIntersectionsInDistince(id, reserveStart, reserveEnd int, crossings []*Crossing){
	...
	for train.Front < distance {
		...
		for _, crossing := range crossings {
			if train.Front == crossing.Position {
				lockIntersectionsInDistince(train.Id, crossing.Position, crossing.Position+train.TrainLength, crossings)
			}
